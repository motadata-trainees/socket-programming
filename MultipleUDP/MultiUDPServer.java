...
public class MultiUDPServer {
            ...
            throws IOException, InterruptedException
    {
        ...
        DatagramSocket ss = new DatagramSocket(9848);
                ...
                try {
                    ...
                    while (true) {
                        synchronized (this)
                        {
                            ...
                            DatagramPacket sp = new DatagramPacket(sd, sd.length, ip, 3656);
                ...
                try {
                    while (true) {
                        synchronized (this)
                        {
                            ...
                            System.out.println("Client (" + sp1.getPort() + "):" + " " + msg.length());
